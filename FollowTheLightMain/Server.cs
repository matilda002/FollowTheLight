                ...
                case "POST":
                    switch (request.Url?.AbsolutePath)
                    {
                        ...
                        case "/game/player/2":
                            ...
                            break;
                        case "/game/player/3":
                            puzzle.PuzzleOneP1(request, response);
                            break;
                        case "/game/player/4":
                        ...
                        case "/game/player/5":
                            ...
                            break;
                        case "/game/player/6":
                            puzzle.PuzzleTwoP1(request, response);
                            break;
                        case "/game/player/7":
                        ...
                        case "/game/player/8":
                            ...
                            break;
                        case "/game/player/9":
                            puzzle.PuzzleThreeP1(request, response);
                            break;
                        case "/game/player2/1":
                        ...
                        case "/game/player2/2":
                            ...
                            break;
                        case "/game/player2/3":
                            puzzle.PuzzleOneP2(request, response);
                            break;
                        case "/game/player2/4":
                        ...
                        case "/game/player2/5":
                            ...
                            break;
                        case "/game/player2/6":
                            puzzle.PuzzleTwoP2(request, response);
                            break;
                        case "/game/player2/7":
                        ...
                        case "/game/player2/8":
                            ...
                            break;
                       case "/game/player2/9":
                            puzzle.PuzzleThreeP2(request, response);
                            break;
